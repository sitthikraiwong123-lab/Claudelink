 ...
 * The app shell (index.html) is fully self-contained: jsPDF, html2canvas and
...
self.addEventListener('fetch', (e) => {
  ...
  // The HTML document (navigations + index.html) uses NETWORK-FIRST so a
  ...
  // index.html after every edit until the cache version is bumped.
